...
return (
    <div className='main-container w-full h-full bg-bgcolor md:px-8'>
    <Nav/>
    <div className="bodycontainer w-full h-auto mt-5">
        ...
        <div className="certificate1 flex justify-between items-start mt-10 h-auto w-full py-2">
            ...
            <img src='../images/nextjsBootcamp.png' className='bg-white h-[150px] w-[150px] md:h-[300px] md:w-[300px] mr-2 md:mr-20' alt='certificates'/>
        </div>

        <div className="certificateCodsoft flex justify-between items-start mt-10 h-auto w-full py-2">
            <div className="words p-2 ml-5 h-auto w-auto gap-5">
            <h1 className='text-xl md:text-2xl font-bold text-white'>ReactJS Developer Internship<span className='text-blue-900'>  (CodSoft)</span></h1>
            <p className="text-slate-500 text-xs md:text-lg font-sans font-normal break-words mt-5">Codsoft's React.js Developer Internship offers an exciting opportunity for aspiring developers to gain hands-on experience with React.js and modern frontend technologies. Interns will work on building and maintaining dynamic web applications, collaborating with experienced developers to learn best practices. The internship provides exposure to state management with Redux, component-driven design, and responsive UI development. It's a great chance to improve coding skills in a professional environment and contribute to real-world projects. Ideal for those looking to kickstart their career in frontend development.</p>
            </div>
            <img src='../images/Codsoft.png' className='bg-white h-[150px] w-[150px] md:h-[300px] md:w-[300px] mr-2 md:mr-20' alt='certificates'/>
        </div>
        ...
        <div className="certificate2 flex justify-between items-start mt-10 h-auto w-full">
            ...
            <img src='../images/agileCertificate.jpg' className='bg-white h-[150px] w-[150px] md:h-[300px] md:w-[300px] mr-2 md:mr-20' alt='certificates'/>
        </div>
        ...
        <div className="certificate3 flex justify-between items-start mt-20 md:mt-10 h-auto w-full">
            ...
            <img src='../images/MarketingCerti.jpg' className='bg-white h-[150px] w-[150px] md:h-[300px] md:w-[300px] mr-2 md:mr-20' alt='certificates'/>
        </div>
        </div>
