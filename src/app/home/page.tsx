...
<div className="innerContainer bg-bgcolorlite rounded-xl h-[600px] w-full relative flex flex-col md:flex-row  ">
    <div className="text flex flex-col justify-start items-start ml-4 md:ml-44">
        ...
        <p className='mt-10 text-slate-500 '>Transforming complex ideas into simple and sophisticated web visuals, leveraging React.js & Next.js,
    ...
    <div className="img">
    <img src='../images/main2.png' className='h-[200px] w-[150px]  lg:h-[300px] lg:w-[300px] xl:h-[450px] xl:w-[450px] rounded-3xl  md:rounded-full border-4 border-bgcolorlite absolute right-10 md:bottom-10 object-cover bg-opacity-30 ' alt='Pfp'/>
    </div>
</div>
</div>
